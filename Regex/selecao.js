/*
   ...
   buscas / substituições de padrões em strings. Os padrões 
   devem ser colocados entre //. Geralmente vamos utilizá-las
...
/*
 ...
 Uma das mais utilizadas é a g, que significa global,
 ou seja, retorne todos os resultados que estiverem 
 dentro do padrão e não apenas o primeiro.
...
/*
         FLAG: I
   Com o i informamos que devem ser ignoradas as diferenças entre 
...
/*
   ...
   A tabela UNICODE é utilizada como referência para definir 
   os caracteres dentro do alcance.
*/
...
/*
      NEGAR
   Utilizando o acento circunflexo podemos negar 
   caracteres. Ou seja, pegue tudo que não seja [^a]
*/
...
/*
   ...
   e o underline. É a mesma coisa que [A-Za-z0-9_].
*/
...
/*
      NOT WORD
   O \W irá selecionar tudo o que não for caracter alfanumérico 
   e o underline. É a mesma coisa que [^A-Za-z0-9_].
*/
...
/*
   ...
   Com as chaves podemos indicar a repetição /b{3}/g. Agora ele está fazendo uma 
   seleção completa e não caracter por caracter.
*/
...
/*
   ...
   Podemos informar o min e max do quantificador /a{2,4}/ vai selecionar 
   quando aparecer a duas vezes ou até 4 vezes. /a{2,}/ irá selecionar 
   quando se repetir duas ou mais vezes.
*/
...
/*
      MAIS +
   O sinal de + significa que devemos selecionar quando 
   existir pelo menos uma ou mais ocorrências.
*/
...
/*
      WORD BOUNDARY \B
   O sinal \b irá indicar que pretendemos fazer uma seleção 
