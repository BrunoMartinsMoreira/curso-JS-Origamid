/*
      PARÂMETROS
   Nem todos os parâmetros que definimos são utilizados quando uma 
   função é executada, devido a falta de argumentos. Por isso é 
   importante nos prepararmos para caso estes argumentos não sejam declarados.
*/
...
/*
   ...
   Antes do ES6 a forma de definirmos um valor padrão para um 
   parâmetro, era através de uma expressão.
*/
function perimetroForma(lado, totalLados) {
...
/*
   ...
   Com o ES6 é possível definirmos o valor de um parâmetro direto na
   declaração do mesmo, caso o argumento não seja passado no
   momento da execução.
*/
...
/*
   ...
   dentro da função. Esse objeto contém os valores dos argumentos.
*/
function perimetroForma(lado, totalLados = 4) {
...
/*
   ...
   Assim todos os argumentos que passarmos na ativação da função, 
...
/*
      REST VS ARGUMENTS
   Apesar de parecidos o parâmetro rest e a palavra arguments possuem grandes
   diferenças. Sendo rest uma array real e arguments um objeto Array-like.
*/
function anunciarGanhadores(premio, ...ganhadores) {
...
/*
      SPREAD ARGUMENT
   O Spread pode ser muito útil para funções que recebem uma 
   lista de argumentos ao invés de uma array.
*/
