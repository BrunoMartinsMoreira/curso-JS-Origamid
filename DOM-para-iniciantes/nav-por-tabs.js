 ...
 *  A ideia de navegação por tabs, é ter uma lista de itens      *
 *  que controla a visualização de uma lista de conteúdo.       *
 *  Cada item da lista possui um conteúdo relacionado ao mesmo.*
 **************************************************************/
...
/********************************************************************
 ******************** FUNÇÃO CALLBACK ******************************
 *  Recebe index como parâmetro para ativar a tab. Sempre que     *
 *  ativar, remove a classe ativo de todos os outros elementos.  *
 ***************************************************************/
...
/********************************************************************* 
 ********************** ADICIONAR O EVENTO ***************************
 * Neste caso precisamos passar antes a fução anônima no callback,  *
...
/********************************************************************************
 ************************* ASSIM QUE CARREGAR **********************************
 *  Adicionar a classe ativo ao primeiro elemento e adicionar a classe        *
...
.js.js - tabcontent section {
   ...
   .js - tabcontent section.ativo {
      ...
      animation: show .5 s forwards;
   }

@keyframes show {
   from {
      opacity: 0;
      transform: translate3d(-30 px, 0, 0);
   }
   to {
      opacity: 1;
