 ...
 * construção do objeto (Constructor Function). Podemos trocar
...
/**
 * EXEMPLO REAL
 * O objeto atribuído a lista será o substituído
 * pelo primeiro argumento de call()
 */
 ...
 * O novo valor de this deve ser semelhante a estrutura
 * do valor do this original do método. Caso contrário
 * o método não conseguirá interagir de forma correta
 * com o novo this.
 */
const novoSeletor = {
 ...
 * construtor Array. Assim podemos estender todos os métodos
 * de Array à objetos que se parecem com uma Array (array-like).
 */
 ...
 * são parecidos com uma array. Por isso conseguimos
 * utilizar os mesmos na substituição do this em call.
 */
 ...
 * a única diferença é que os argumentos da função são
 * passados através de uma array.
 */
 ...
 * não irá executar a função mas sim retornar a mesma com
 * o novo contexto de this.
 */
const li = document.querySelectorAll('li');
...
/**
 * ARGUMENTOS COMUNS
 * Podemos passar argumentos padrões para
 * uma função e retornar uma nova função.
 */
